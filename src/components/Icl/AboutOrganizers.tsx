...
export const AboutOrganizers = () => {
  return (
    <div className="my-40 mb-80 sm:my-60 sm:mb-0 mt-100 flex h-[50dvh] w-full flex-col items-center">
      <Image
        src={glowEclipse}
        alt="glow eclipse"
      ...
      <div className="mt-40 flex max-w-[770px] flex-col text-center">
        <p className="text-[20px] font-extrabold text-[#AAA9A9]">About Us</p>
